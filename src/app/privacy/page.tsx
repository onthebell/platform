      ...
      <div className="max-w-4xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8">
        <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 lg:p-8">
          <div className="text-center mb-6 sm:mb-8">
            <ShieldCheckIcon className="h-12 w-12 sm:h-16 sm:w-16 text-blue-600 mx-auto mb-3 sm:mb-4" />
            ...
            <p className="text-xs sm:text-sm text-gray-600 mt-2">Effective Date: May 28, 2025</p>
          </div>

          <div className="prose prose-sm sm:prose-base lg:prose-lg max-w-none">
            <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-3 sm:mb-4 flex items-center">
              <ServerStackIcon className="h-5 w-5 sm:h-6 sm:w-6 mr-2 flex-shrink-0" />
              Information We Collect
            </h2>

            <h3 className="text-lg sm:text-xl font-medium text-gray-900 mt-4 sm:mt-6 mb-2 sm:mb-3">
              Account Information
            </h3>
            <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4 leading-relaxed">
              When you create an account, we collect:
            </p>
            <ul className="list-disc pl-4 sm:pl-6 text-sm sm:text-base text-gray-700 mb-4 sm:mb-6 space-y-1 sm:space-y-1">
              <li>Email address</li>
              <li>Display name</li>
            ...
            <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-3 sm:mb-4 flex items-center">
              <EyeIcon className="h-5 w-5 sm:h-6 sm:w-6 mr-2 flex-shrink-0" />
            ...
            <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-3 sm:mb-4 flex items-center">
              <GlobeAltIcon className="h-5 w-5 sm:h-6 sm:w-6 mr-2 flex-shrink-0" />
              Information Sharing and Disclosure
            </h2>

            <div className="bg-green-50 border border-green-200 rounded-lg p-4 sm:p-6 mb-4 sm:mb-6">
              <h3 className="text-green-900 font-semibold mb-2 text-base sm:text-lg">
                What We DON'T Do
              </h3>
              <ul className="list-disc pl-4 sm:pl-6 text-sm sm:text-base text-green-800 space-y-1">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 sm:p-6 mb-4 sm:mb-6">
              <h3 className="text-blue-900 font-semibold mb-2 text-base sm:text-lg">
            ...
            <ul className="list-disc pl-4 sm:pl-6 text-sm sm:text-base text-gray-700 mb-4 sm:mb-6 space-y-1">
            ...
            <div className="bg-gray-100 border border-gray-200 rounded-lg p-4 sm:p-6 mt-6 sm:mt-8">
