          ...
          <div className="prose prose-sm sm:prose-base lg:prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                OnTheBell facilitates connections between users but is not a party to any
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">OnTheBell reserves the right to:</p>
              <ul className="list-disc pl-6 text-gray-700 mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                OnTheBell shall not be liable for any direct, indirect, incidental, special, or
                consequential damages resulting from platform use, including but not limited to
                marketplace transactions, user interactions, or technical issues.
              </p>
            </section>
            ...
            <div className="bg-gray-50 rounded-lg p-6 mt-8">
              <p className="text-sm text-gray-600">
                These Terms of Service were last updated on May 28, 2025. We may update these terms
                from time to time, and will notify users of significant changes through the platform
                or email.
              </p>
            </div>
          </div>
