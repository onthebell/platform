...
export const metadata: Metadata = {
  ...
  description: 'Learn about OnTheBell, the community platform for residents of the Bellarine Peninsula',
};
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div>
                ...
                <p className="text-gray-700">
                  Every decision we make is guided by what's best for our community members 
                  and the Bellarine Peninsula as a whole.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-medium text-gray-900 mb-2">Local Focus</h3>
                <p className="text-gray-700">
                  We're built by locals for locals, ensuring our platform meets the unique 
                  needs of Bellarine Peninsula residents.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-medium text-gray-900 mb-2">Safety & Trust</h3>
                <p className="text-gray-700">
                  Through address verification and community moderation, we maintain a 
                  safe and trustworthy environment for all members.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-medium text-gray-900 mb-2">Accessibility</h3>
                <p className="text-gray-700">
                  We believe community connection should be available to everyone, which 
                  is why OnTheBell is free to use for all residents.
                </p>
              </div>
            </div>
            ...
            <div className="bg-blue-50 p-6 rounded-lg mt-8">
              ...
              <p className="text-blue-800">
                ...
                feedback on how we can improve, or ideas for new features, please don't hesitate 
                to reach out to us.
              </p>
            </div>
          </div>
